...
class MophApiClient:
    """ฟังก์ชันกลางสำหรับ token และส่ง API ของ MOPH หลายงาน"""
    ...
    def send_dmht(self, payload: dict[str, Any]) -> ApiResult:
        return self.post_json(self.config.send_dmht_url, payload)
